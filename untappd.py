...
csv_header = ['beer_name', 'brewery_name', 'beer_type', 'beer_abv', 'beer_ibu', 'comment', 'venue_name',
...
def main():
    ...
    print("You have " + str(len(data)) + ' total check-ins with ' + str(len(uniques)) + ' uniques and ' +
    ...
    print('\nCreated ' + fne + ' and ' + fnej + ' with just your unique beer check-ins')
